...
### Fixed
- API credential persistence bug where handles would overwrite existing credentials.
- Optimized extension package size by excluding source directories and redundant dependencies (reduced by 95%+).
